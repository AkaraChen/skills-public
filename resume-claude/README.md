...
- `SKILL.md` —— 薄壳：设置 `TOOL=TOOLresume-claude`，指向本目录的 `references/resume-session/f15d9c0163b103095a293f8d025fb8a490634ac95dafc85aed56d4b502cf7944.md`
...
- Original files: `~/.grok/bundled/skills/resume-claude/SKILL.md` and `~/.grok/bundled/skills/shared/resume-session/{f15d9c0163b103095a293f8d025fb8a490634ac95dafc85aed56d4b502cf7944.md,session_reader.py}`
...
| 文件 | 上游 SHA-256 | 本仓库 |
| --- | --- | --- |
| `SKILL.md` | `2895371698c2e57887e60a261ba30525212da80aa08ffe9bf8f8c32a22a6003e` | `55a03cdd8e7a7e2d8a4335a2158d67bab3063d5f575e5b5fc1b36faa708bd242`（仅上面那一行路径不同） |
